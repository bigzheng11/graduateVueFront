...
export default {
   ...
   methods: {
      ...
      */
      loadImagex() {
         let size = ["300x460", "300x370", "300x500", "300x250"];
   ...
   mounted() {
      ...
      const scrollDiv = document.getElementsByClassName("container")[0];
      const scrollDiv2 = this.$refs.container;

      const offsetHeight = scrollDiv.offsetHeight;
      console.log("offsetHeight:-->", offsetHeight);

      //绑定事件
      scrollDiv2.addEventListener("scroll", function (e) {
          
         console.log("e.target.scrollTop:--->", scrollDiv.scrollTop);
         console.log("scrollDiv.scrollTop:--->", scrollDiv.scrollTop);
         console.log("scrollDiv.offsetTop:--->", scrollDiv.offsetTop);
