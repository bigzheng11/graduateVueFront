      ...
      this.$axios
         ...
         .then((response) => {
            ...
            this.$axios
               ...
               .then((response) => {
                  console.log("response.data.data.collectList",response.data.data.collectList);
                  for (const item of response.data.data.collectList) {
                     if (item.goodsID == this.recommendGoodList.goodsID) {
