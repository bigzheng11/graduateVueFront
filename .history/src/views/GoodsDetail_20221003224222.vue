         ...
         if (indexIn === undefined) {
            ...
            this.messageList[indexOut].childList[indexIn].isFavour =
               !this.messageList[indexOut].childList[indexIn].isFavour;
                ...
                // 先修改本地数字
            this.messageList[indexOut].childList[indexIn].favour += this.messageList[indexOut].childList[indexIn]
               .isFavour
               ? 1
               : -1;
            //再修改后台
            this.$axios
               .post(
                  ...
                  this.$qs.stringify({
                     messageID: messageID,
                     favour: this.messageList[indexOut].childList[indexIn].favour,
                  })
               )
               .then((response) => {
               })
