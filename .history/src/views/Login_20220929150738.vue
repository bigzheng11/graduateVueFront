<template>
   <div class="container">
      ...
      <div style="margin: 15% 0 0 25%;">
         <van-button type="info" @click="toLogin" style="width:90px;font-size:40px">登录</van-button>
         <van-button
            plain
            type="info"
            @click="toRegister"
            style="margin-left: 30%;width:90px;font-size:40px"
            >注册</van-button
         >
      </div>
   </div>
