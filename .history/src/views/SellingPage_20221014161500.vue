<template>
   <div class="container" style="margin: 10px">
      ...
      <div>
         <div><van-icon name="after-sale" />价格:<svg t="1665735254635" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1675" width="20px" height="20"><path d="M350.912 605.376l-299.968-182.72 908.48-355.648-159.072 818.272-387.04-247.872L759.264 263.936zM416 704v209.92l128.256-130.208z" p-id="1676" fill="#1296db"></path></svg></div>
         <el-input
            style="width: 300px"
            v-model="goods.price"
            placeholder="请输入内容"
