   ...
   <div class="container">
      ...
      >
         <el-card shadow="never" style="border-radius: 10px">
            ...
            />
            <!-- 商品名 -->
            <span class="orderName" style="position: relative">
               {{ item.goodsName }}
            </span>
            <!-- 购买数量 -->
            <span style="position: absolute;top:190p">
               实际付款数量:{{ item.quantity }}
            </span>
            <!-- 购买时间 -->
            <div class="userComment" style="position: absolute;right: 140px;bottom: 10px;">
               2022-10-7,12:00
            </div>
