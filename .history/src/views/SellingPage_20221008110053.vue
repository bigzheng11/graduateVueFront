<template>
   <div class="container">
      ...
      <div>
         商品名:<el-input v-model="goods.goodsName" placeholder="请输入内容"></el-input>
      </div>
      ...
      <div>
         价格:<el-input v-model="goods.goodsName" placeholder="请输入内容"></el-input>
      </div>
