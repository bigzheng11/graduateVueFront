...
export default {
   ...
   methods: {
      ...
      showPopup(toMessageID, parentTop) {
         this.show = true;
         console.log("===========================");
         console.log("toMessageID", toMessageID);
         console.log("parentTop", parentTop);
         console.log("isNaN(toMessageID)", isNaN(toMessageID));
         console.log("isNaN(toMessageID)", typeof(toMessageID));
         console.log("===========================");

         if (isNaN(toMessageID)) {
            // 添加子评论:朝向父/朝向子
