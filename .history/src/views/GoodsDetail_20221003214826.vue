      ...
      <div class="leaveMessage">
         <div v-for="(item, indexOut) in messageList" :key="item.messageID">
            ...
            >
               ...
               <!-- 点赞 -->
               <span
                  @click="addfavour(itemTwo.messageID, indexOut, indexIn)"
                  style="
                     position: absolute;
                     right: 6%;
                     top: 12%;
               ...
               >
                  ...
                  <van-icon :name="itemTwo.favour ? 'like' : 'like-o'" />
                  <p style="font-size: 15px; margin-top: -7px">
                     {{ itemTwo.favour }}
                  </p>
               </span>
...
export default {
   ...
   methods: {
      //点赞方法
      addfavour(messageID, indexOut, indexIn) {
         this.messageList[indexOut].childList[indexIn].favour =0;

         console.log("点击事件触发");
         console.log(this.messageList[indexOut].childList[indexIn].isFavour);
         console.log(this.messageList[indexOut].childList[indexIn].messageID);
         // this.$axios
         //    .get("api/collect/getall/" + this.user.userID)
         //    .then((response) => {
