      ...
      >
         <el-card shadow="never" style="border-radius: 10px">
            ...
            <img
               :src="item.picList[0].picture"
               alt=""
               style="height: 74px; border-radius: 10px;position:absolute"
            />
            <!-- 商品名 -->
            <span class="orderName" style="position:absolute">
               {{ item.goodsName }}
            </span>
            <!-- 购买数量 -->
            <span style="position:absolute"> 实际付款数量:{{ item.quantity }} </span>
            <!-- 购买时间 -->
            <div class="userComment" style="position:absolute">2022-10-7,12:00</div>
            <button style="position:absolute">查看商品详情</button>
         </el-card>
      </div>
   </div>
</template>
