   ...
   <div class="container">
      <div class="top">
         <img
            ...
            alt=""
            style="width: 200px; height: 200px; margin: 0 0 0 24%"
         />
         <h1 style="margin-left: 24%">欢迎来到蔬荐</h1>
      </div>
      ...
      <div style="margin: 25% 25% 0 0">
         <van-button type="info" @click="toLogin" 
            >登录</van-button
         >
         <van-button plain type="info" @click="toRegister" style="margin-left: 30%">注册</van-button>
      </div>
   </div>
</template>
