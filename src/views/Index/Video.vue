        ...
        on: {
          ...
          slidePrevTransitionStart: () => {
            if (this.page > 1) {
              ...
              //计算停留时常
              this.stayTime = (this.timer01 - this.timer02) / 1000;
              ...
              console.log("停留时长", this.stayTime, "秒");
              //计时02:
  ...
  created() {
    ...
    this.$axios
        ...
        .then((response) => {
          ...
          console.log(
              "=====获取该用户下所有推荐的商品列表recommendGoodList======",
          ...
          console.log("本地播放列表:", this.dataList);
          console.log("======存入vuex中=====");
          //加入Vuex中
          this.$store.dispatch(
