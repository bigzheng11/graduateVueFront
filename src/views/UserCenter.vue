    ...
    <div class="topDiv" ref="topDiv" @touchmove.prevent>
      ...
      <div class="userImg">
        <el-upload
            ...
            action="http://localhost:8081/header/upload"
      ...
      <div class="userDetail">
        ...
        <h5 @click="toAddress">
          {{
            addressDefault == null ? "没有设置默认地址" : addressDefault
          }}(点击修改)
        </h5>
      </div>
...
export default {
  ...
  created() {
    ...
    this.addressDefault = this.$qs.parse(
          ...
          for (const iterator of this.addressList) {
            if (iterator.isDefault === 1) {
              if (
                ...
                this.addressDefault =
                    iterator.provinceCity + iterator.addressDetail;
              }
            }
          }
        })
